...
URL_ALVO = "http://192.168.0.107:8000/api/busca/marca/nome?nome=dell"   # URL para a qual os testes serão enviados #dia 2
    ...
    async with aiohttp.ClientSession(connector=connector) as session:
        ...
        async def disparar_req():
            ...
            while True:
                ...
                try:
                    async with session.post(url, timeout=200) as response:
...
def main():
    ...
    caminho_config = os.path.join(diretorio_atual, "NivelDeTesteDia2.txt")
